import { getProducts, search } from '@/api/productApi';
    ...
    <>
        ...
        <div className='grid grid-cols-1 place-content-center gap-14 mb-[15vh] md:grid-cols-4'>
          ...
          {products.length !== 0 ? (
            products.map((product: Product, idx) => (
              <a key={product.p_id} href='/product'>
      ...
      <div className='text-foreground flex place-content-center bg-background gap-6 pb-10'>
        <Button
          size={'sm'}
          disabled={page <= 0}
          onClick={(e) => getProductsPaginated(e, false)}
        >
          <Icons.MoveLeft />
        </Button>
        <div>
        ...
        <Button
          size={'sm'}
          onClick={(e) => getProductsPaginated(e, true)}
